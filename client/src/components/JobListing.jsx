...
const JobListing = () => {
    ...
    //       console.log("Checking category:", job.category);
    //       return selectedCategories.length === 0 || selectedCategories.includes(job.category);
    //     };
      
    //     const matchesLocation = (job) => {
    //       console.log("Checking location:", job.location);
    //       return selectedLocations.length === 0 || selectedLocations.includes(job.location);
    //     };
      
    //     const matchesTitle = (job) => {
    //       console.log("Checking title:", job.title);
    //       return searchFilter.title === "" || job.title?.toLowerCase().includes(searchFilter.title.toLowerCase());
    //     };
      
    //     const matchesSearchLocation = (job) => {
    //       console.log("Checking searchFilter location:", job.location, searchFilter.location);
    //       return (
