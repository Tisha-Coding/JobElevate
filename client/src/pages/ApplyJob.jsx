...
const ApplyJob = () => {
  ...
  },[id,jobs]) // whenever the job id will be called , this function will get changed
    ...
    <>
     ...
     <div className='min-h-screen flex flex-col py-10 container px-4 2xl:px-20 mx-auto'>
      ...
      <div className='flex flex-col justify-center text-end text-sm max-md:mx-auto max-md:text-center'>
        ...
        {/* will see its working after 1 hour */}
        <p className='mt-1 text-gray-600'>Posted {moment(JobData.date || Date.now()).fromNow()}</p>
      </div>
